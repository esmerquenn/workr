const translations = {
  az: {
    ...
    service_airport: "<i class='fa-regular fa-circle-check'></i> <span>Hava Limanı Transferləri </span>",
    service_vip: "<i class='fa-regular fa-circle-check'></i> <span>VIP köçürmələr</span>",
    service_rental: "<i class='fa-regular fa-circle-check'></i> <span>Sürücü ilə avtomobil icarəsi </span>",
    service_excursion:
      "<i class='fa-regular fa-circle-check'></i> <span>İstəyinizə uyğun olaraq istənilən istiqamətə ekskursiyalar</span>",
    service_tours: '<i class="fa-regular fa-circle-check"></i> <span>Turlar</span>',
    ...
    address: "Ünvan",
    phone: "Telefon",
    email_address: "E-mail ünvanı",
    form_title: "SUAL VƏ YA ŞƏRHLƏRİNİZ ÜÇÜN FORMU DOLDURUN",
    name: "Ad",
    surname: "Soyad",
    email: "E-mail ünvanı",
    message: "Mesaj",
    submit: "Göndər",
    details_title: "Təfərrüatlar",
    service_type: "Servis tipi",
    standard_price: "Standart qiymət",
    transfer_type: "Transfer tipi",
    one_way: "Bir istiqamət",
    route: "Marşrut",
    pickup_date_time: "Götürmə tarixi və zamanı",
    total_distance: "Ümumi məsafə",
    total_time: "Ümumi vaxt",
    thank_you: "Təşəkkür edirik!",
    order_accepted: "Sifarişiniz qəbul olundu",
    order: "Sifariş",
    select: "Seçim et",
    selected: "Seçildi",
  },
  en: {
    ...
    service_airport: "<i class='fa-regular fa-circle-check'></i> <span>Airport Transfers </span>",
    service_vip: "<i class='fa-regular fa-circle-check'></i> <span>VIP Transfers </span>",
    service_rental: "<i class='fa-regular fa-circle-check'></i> <span>Car Rental with Driver </span>",
    service_excursion: "<i class='fa-regular fa-circle-check'></i> <span>Excursions to any direction as per your request </span>",
    service_tours: '<i class="fa-regular fa-circle-check"></i> <span>Tours</span>',
    ...
    form_title: "Fill out the form for questions or comments",
    name: "Name",
    surname: "Surname",
    email: "Email Address",
    message: "Message",
  ...
  ru: {
    ...
    service_airport: "<i class='fa-regular fa-circle-check'></i> <span>Трансферы из аэропорта </span>",
    service_vip: "<i class='fa-regular fa-circle-check'></i> <span>VIP-трансферы </span>",
    service_rental: "<i class='fa-regular fa-circle-check'></i> <span>Аренда автомобиля с водителем </span>",
    service_excursion: " <i class='fa-regular fa-circle-check'></i> <span>Экскурсии по любому направлению на ваш выбор</span>",
    service_tours: " <i class='fa-regular fa-circle-check'></i> <span>Туры</span>",
    ...
    form_title: "Заполните форму для вопросов или комментариев",
    name: "Имя",
    surname: "Фамилия",
    ...
    route: "Маршрут",
    pickup_date_time: "Дата и время получения",
