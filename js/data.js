...
step_document = [
  {
    id: 0,
    data: `<div class="step_1_div flex flex-col md:flex-row gap-12 md:gap-5">
      <div class="flex-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="bg-white border">
            <label for="name" class="block text-base tt px-4 pt-4 font-medium label_1">
              Götürmə tarixi
            </label>
            <input  id="datepicker" type="text" name="name" class="w-full p-2 focus:outline-none" />
          </div>
          <div class="bg-white border">
            <label for="time" class="block text-base tt px-4 pt-4 font-medium label_1">
              Götürmə vaxtı
            </label>
        ...
        <div class="bg-white border pr-2">
          <label for="routeSelect" class="block text-base tt px-4 pt-4 font-medium label_1">
            Marşrut
          </label>
          <select id="routeSelect" class="w-full p-2 focus:outline-none" onchange="calculateAndDisplayRoute()">
              ...
              <option value='{"lat":39.2097, "lng":45.4129, "name":"Naxçıvan"}'>Naxçıvan</option>
              <option value='{"lat":38.754, "lng":48.8506, "name":"Lənkəran"}'>Lənkəran</option>
              <option value='{"lat":40.3777, "lng":49.9183, "name":"Şirvan"}'>Şirvan</option>
              <option value='{"lat":41.092, "lng":45.4556, "name":"Qəbələ"}'>Qəbələ</option>
              <option value='{"lat":40.6219, "lng":47.1522, "name":"Ağdam"}'>Ağdam</option>
              <option value='{"lat":39.4581, "lng":48.5442, "name":"Masallı"}'>Masallı</option>
          </select>
        </div>
        <div class="bg-white border pr-2">
          <label for="transfer_type" class="block text-base tt px-4 pt-4 font-medium label_1">
            Transfer tipi
          </label>
      ...
      <div class="w-full md:w-1/2 flex flex-col">
            <div id="map" class="w-full h-52 md:h-62  border z-10 mb-0 pb-0"></div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div class="card p-5 bg-[#f9fafb] border rounded-md">
                    ...
                    <button
                      ...
                      class=" flex justify-between items-center py-2 w-full lg:py-3 px-6 border-2 border-[#FB3D27] hover:bg-[#FB3D27] duration-300 transition text-base hover:text-white rounded-full"
                    >
                     Seçim et
                    </button>
                  </div>
